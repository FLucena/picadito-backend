...
public class ParticipanteService {
    ...
    public ParticipantesResponseDTO obtenerParticipantesPorPartido(@NonNull Long partidoId) {
        ...
        List<ParticipanteResponseDTO> participantes = participanteRepository.findByPartidoId(partidoId).stream()
                .map(this::convertirADTO)
                .collect(Collectors.toList());
        return new ParticipantesResponseDTO(participantes);
    }
